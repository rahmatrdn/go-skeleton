...
import (
	...
	_ "gitlab.spesolution.net/bni-merchant-management-system/go-sekeleton/docs"
	...
	presenterJson "gitlab.spesolution.net/bni-merchant-management-system/go-sekeleton/internal/presenter/json"
