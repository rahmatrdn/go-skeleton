...
func (_m *TodoListRepository) Create(ctx context.Context, dbTrx mysql.TrxObj, wallet *entity.TodoList, nonZeroVal bool) error {
...
func (_m *TodoListRepository) DeleteByID(ctx context.Context, dbTrx mysql.TrxObj, walletID int64) error {
...
type mockConstructorTestingTNewTodoListRepository interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewTodoListRepository(t mockConstructorTestingTNewTodoListRepository) *TodoListRepository {
